...
export default function Header() {
  ...
  return (
            ...
            >
                ...
                {movies.map((movie, index) => (
                    ...
                    >
                        ...
                        <div
                            className={`absolute inset-0 shadow-lg rounded-md ${
                            currentSlide === index
                        ...
                        >
                            ...
                            <div
                            className="absolute inset-0 bg-gradient-to-t from-black via-black/60
                                    to-black/20"
                            ></div>
                            ...
                            <div className="bg-black/90 p-2 rounded-b-md">
                                <h5 className="text-xs text-white font-medium line-clamp-1">
                                {movie.title}
                                </h5>
                            </div>
                            </div>
        ...
        {/* Footer area */}
        <div
            className="absolute bottom-0 left-0 right-0 z-30 flex flex-col md:flex-row justify-between items-center 
